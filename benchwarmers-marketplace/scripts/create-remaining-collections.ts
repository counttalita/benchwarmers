...
// Only the collections that don't exist yet
...
async function createRemainingCollections() {
  console.log('🚀 Creating remaining Appwrite collections...\n')

  for (const [collectionId, config] of Object.entries(REMAINING_COLLECTIONS)) {
  ...
  console.log('🎉 All remaining collections created successfully!')
  console.log('\n📝 Created Collections:')
  Object.entries(REMAINING_COLLECTIONS).forEach(([id, config]) => {
...
export { REMAINING_COLLECTIONS, createRemainingCollections }
