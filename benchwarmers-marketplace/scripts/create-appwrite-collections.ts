...
// Collection IDs and configurations
const COLLECTIONS_CONFIG = {
  ...
  talent_profiles: {
    ...
    attributes: [
      ...
      { id: 'certifications', type: 'string', required: false, size: 10000 },
      ...
      { id: 'availabilityCalendar', type: 'string', required: false, size: 10000 },
  ...
  talent_requests: {
    ...
    attributes: [
      ...
      { id: 'preferredSkills', type: 'string', required: false, size: 10000 },
  ...
  offers: {
    ...
    attributes: [
      ...
      { id: 'startDate', type: 'datetime', required: true },
      { id: 'durationWeeks', type: 'integer', required: true },
      { id: 'terms', type: 'string', required: false, size: 10000 },
...
async function createCollections() {
  console.log('🚀 Creating Appwrite collections automatically...\n')
